...
object LangData {
    ...
    private val detail = arrayOf(
            ...
            "Python adalah bahasa pemrograman tujuan umum tingkat tinggi yang ditafsirkan. Filosofi desain Python menekankan keterbacaan kode dengan penggunaan lekukan yang signifikan. Konstruksi bahasanya serta pendekatan berorientasi objeknya bertujuan untuk membantu pemrogram menulis kode yang jelas dan logis untuk proyek skala kecil dan besar.\n" +
                    "\n" +
                    "Python diketik secara dinamis dan dikumpulkan dari sampah. Ini mendukung beberapa paradigma pemrograman, termasuk pemrograman terstruktur (khususnya, prosedural), berorientasi objek dan fungsional. Python sering digambarkan sebagai bahasa \"termasuk baterai\" karena pustaka standarnya yang komprehensif. (diterjemahkan menggunakan google translate)", // Python
            ...
            "Ruby adalah bahasa pemrograman tujuan umum tingkat tinggi yang ditafsirkan. Ini dirancang dan dikembangkan pada pertengahan 1990-an oleh Yukihiro \"Matz\" Matsumoto di Jepang.\n" +
                    "\n" +
                    "Ruby diketik secara dinamis dan menggunakan pengumpulan sampah dan kompilasi tepat waktu. Ini mendukung beberapa paradigma pemrograman, termasuk pemrograman prosedural, berorientasi objek, dan fungsional. Menurut penciptanya, Ruby dipengaruhi oleh Perl, Smalltalk, Eiffel, Ada, BASIC, dan Lisp. (diterjemahkan menggunakan google translate)" // Ruby
    )
